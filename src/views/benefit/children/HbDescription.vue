<template>
  <div class="markdown">
    ...
    <p id="q9-">Q9: 互斥红包怎么使用？</p>
    <ul>
      <li>
        互斥红包不与其他优惠活动（包含但不限于：新用户专享、满X元减X元、满X元赠XX）同时使用。
      </li>
    </ul>
    <p id="q10-">Q10: 返红包活动， 红包领取规则是什么?</p>
    <ul>
      <li>同一个手机号一天限领取三个。</li>
      <li>同一注册用户一天限领取三个。</li>
